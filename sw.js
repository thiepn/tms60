'use strict';
const CACHE='tms60-vnext-2026-08-24c';
const CORE=['./','./index.html','./app.html','./translations.js','./enhancements.js','./enhancements-core.js','./favicon.svg','./icon-192.png','./icon-512.png','./manifest.webmanifest'];
