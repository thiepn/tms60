'use strict';
const CACHE='tms60-vnext-2026-08-24b';
const CORE=['./','./index.html','./app.html','./translations.js','./enhancements.js','./enhancements-core.js','./favicon.svg','./manifest.webmanifest'];
